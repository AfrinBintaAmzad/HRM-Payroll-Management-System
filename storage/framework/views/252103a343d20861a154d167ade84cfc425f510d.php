...
<div class="tab-content">
      ...
      <div class="tab-pane fade show active form-step" id="Service_information">
        ...
        <form method="post" id="myForm" action="<?php echo e(route('manpower_add_action')); ?>" onsubmit="return validateForm()">
          <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('manpower_list')); ?>">  <button type="button" class="btn btn-primary">Go Back</button> </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr_batch1_mid\resources\views/manpowers/add.blade.php ENDPATH**/ ?>